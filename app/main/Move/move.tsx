...
export default function MoveElem (params: any) {
  ...
  return (
    <>
      <div className="platform-select flex md:w-96 items-center justify-around bg-gradient-to-r from-purple-950 to-indigo-900 rounded shadow-inner">
      ...
      <div className="control-select flex md:w-96 items-center justify-around bg-gradient-to-r from-purple-950 to-indigo-900 my-5 rounded shadow-inner">
